<div>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between"><h5>Curso</h5></div>
          <div class="card-body">
    ...
    <x-form-horizontal-icon>
        ...
        <x-slot name="modal">
            <x-modal_template>
                <x-slot name="titulo">¿Estás seguro que quiere añadir esta asistencia?</x-slot>
                <x-slot name="contenido">Los datos NO se podrán modificar más adelante.</x-slot>
            </x-modal_template>
        </x-slot>
