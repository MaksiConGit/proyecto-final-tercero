<x-template-layout>
    <div class="container">
        <x-form-horizontal-icon>
            ...
            <x-slot name="action">{{ route('timetables.store') }}</x-slot>
            ...
            <x-slot name="inputs">
                <x-input-select>
                    ...
                    <x-slot name="opciones">
                        ...
                        @foreach ($institutions as $institution)
                            <option {{ old('institution_id') == $institution->id ? 'selected' : '' }} value="{{ $institution->id }}">
                                {{ $institution->name }}
                            </option>
                        @endforeach
                    </x-slot>
                ...
                <div id="dias-container">
                    <!-- Contenedor para los días y materias dinámicas -->
                </div>
