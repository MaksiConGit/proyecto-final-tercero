<x-template-layout>
    <x-slot name="titulo">Añadir Curso</x-slot>
    <x-slot name="li">
        <li class="menu-item">
    ...
    <div class="container">
        <x-form-horizontal-icon>
            <x-slot name="titulo">Crear curso</x-slot>
            <x-slot name="action">{{route('courses.store')}}</x-slot>
            ...
            <x-slot name="inputs">
                ...
                <x-input-text>
                    ...
                    <x-slot name="value">{{old('course_number')}}</x-slot>
                </x-input-text>
                <x-input-text>
                    <x-slot name="icon">bx bx-buildings</x-slot>
                    ...
                    <x-slot name="value">{{old('section')}}</x-slot>
                </x-input-text>
            </x-slot>
            <x-slot name="modal">
                <x-modal_template>
