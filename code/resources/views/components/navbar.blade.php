                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                ...
                                <div class="avatar avatar-online">
                                    <img src="../template_files/assets/img/avatars/1.png" alt
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    @if (Auth::user()->accountable)
                                                        {{ Auth::user()->accountable->name ?? '' }}
                                                        {{ Auth::user()->accountable->lastname ?? '' }}
                                                    @else
                                                        No asignado
                                                    @endif
                                                </small>
                                ...
                                @if (auth()->user()->hasRole('Teacher'))
                                    <li>
                                        <a class="dropdown-item" href="{{ route('exams.create') }}">
                                            ...
                                            <span class="align-middle">Crear Exámen</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('grades.create') }}">
                                            <i class="bx bx-file me-2"></i>
                                            <span class="align-middle">Cargar Calificaciones</span>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="dropdown-divider"></div>
